...
from bots.applications._base import Application as BaseApplication


class Echo(BaseApplication):
    class Arguments(BaseApplication.Arguments):
    ...
    async def echo(self, update: Update, _: ContextTypes.DEFAULT_TYPE) -> None:
        if update.message:
